...
function getAllBusiness() {
  return knex('Acesso2')
    ...
    .sum('Acesso2.VALOR as quantity')
    .select('Empresa.Autorizada as label')
    .groupBy('label')
    .orderBy('quantity', 'DESC')
    .where('Acesso2.ANOMES', 'LIKE', '2018%')
    .limit(5)
}
...
function getByRegionBusiness(Cod_Regiao) {
  return knex('Acesso2')
    ...
    .select('Empresa.Autorizada as label')
    .groupBy('label')
    .where('Regiao.Cod_Regiao', Cod_Regiao)
    .andWhere('Acesso2.ANOMES', 'LIKE', '2018%')
    .orderBy('quantity', 'DESC')
    .limit(5)
}
...
function getByStateBusiness(Cod_State) {
  return knex('Acesso2')
    ...
    .select('Empresa.Autorizada as label')
    .groupBy('label')
    .where('Estado.Cod_Estado', Cod_State)
    .andWhere('Acesso2.ANOMES', 'LIKE', '2018%')
    .orderBy('quantity', 'DESC')
    .limit(5)
}
